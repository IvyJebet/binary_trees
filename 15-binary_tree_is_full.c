 ...
 *              meaning that every node in the tree has either zero or
 *              two children.If the tree is not full, the function
 ...
 *              meaning that every node has zero or two children.
 *              If the tree is NULL or not full, the function returns 0.
